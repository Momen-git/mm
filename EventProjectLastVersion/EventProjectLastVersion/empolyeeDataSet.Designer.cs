...
namespace EventProjectLastVersion {
    ...
    public partial class empolyeeDataSet : global::System.Data.DataSet {
        ...
        public partial class employeeDataTable : global::System.Data.TypedTableBase<employeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public employeeRow AddemployeeRow(string Name, string password) {
...
namespace EventProjectLastVersion.empolyeeDataSetTableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[employee] WHERE (([Name] = @Original_Name) AND ([password] = @" +
                "Original_password))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[employee] ([Name], [password]) VALUES (@Name, @password);\r\nSEL" +
                "ECT Name, password FROM employee WHERE (Name = @Name)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[employee] SET [Name] = @Name, [password] = @password WHERE (([Name]" +
                " = @Original_Name) AND ([password] = @Original_password));\r\nSELECT Name, passwor" +
                "d FROM employee WHERE (Name = @Name)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EventProjectLastVersion.Properties.Settings.Default.empolyeeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Name, password FROM dbo.employee";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT * FROM employee WHERE ([Name] = @name AND [password] = @pass)";
            ...
            this._commandCollection[2].CommandText = "UPDATE [dbo].[employee] SET [Name] = @Name, [password] = @password WHERE (([Name]" +
                " = @Original_Name));\r\nSELECT Name, password FROM employee WHERE (Name = @Name)";
        ...
        public virtual int Fill(empolyeeDataSet.employeeDataTable dataTable) {
        ...
        public virtual empolyeeDataSet.employeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            empolyeeDataSet.employeeDataTable dataTable = new empolyeeDataSet.employeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(empolyeeDataSet.employeeDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual string checks(string name, string pass) {
        ...
        public virtual int UpdateQuery(string Name, string password, string Original_Name) {
